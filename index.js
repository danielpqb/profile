...
function selectCategory() {
    ...
    switch (Number(this.id)) {
        case 1: //Resume
            ...
            document.querySelector('.cssFile').innerHTML = `<link rel="stylesheet" href="css/resume.css"></link>`
            break;
        case 2: //Portfolio
            document.querySelector('.page').innerHTML = portfolioContent
            document.querySelector('.cssFile').innerHTML = `<link rel="stylesheet" href="css/portfolio.css"></link>`
            break;
        case 3: //Contact
            document.querySelector('.page').innerHTML = contactContent
            document.querySelector('.cssFile').innerHTML = `<link rel="stylesheet" href="css/contact.css"></link>`
            break;
        default: //About Me
            document.querySelector('.page').innerHTML = aboutmeContent
